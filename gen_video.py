...
def gen_interp_video(G, mp4: str, seeds, shuffle_seed=None, w_frames=60*4, kind='cubic', grid_dims=(1,1), num_keyframes=None, wraps=2, psi=1, device=torch.device('cuda' if torch.cuda.is_available() else "cpu"), **video_kwargs):
    grid_w = grid_dims[0]
    grid_h = grid_dims[1]
